...
typedef struct
{
    ...
    volatile uint32_t AUD_ADC_CFG2;               /*! 0xF0  reserved */
    volatile uint32_t AUD_ADC_RDATA;              /*! 0xF4  reserved */
    volatile uint32_t RC_CLK_STA;                 /*! 0xF8           */
    volatile uint32_t RF_TEST_CFG;                /*! 0xFC           */
    volatile uint32_t res1;                /*! 0x100           */
    volatile uint32_t res2;                /*! 0x104           */
    volatile uint32_t PERI_SEL;                /*! 0x108           */
} SysCtrlRegs_Type;
...
#define SYS_CTRL_CLK_EN0_BLE_POS                    (28UL) 
#define SYS_CTRL_CLK_EN0_BLE_MASK                   (1UL << SYS_CTRL_CLK_EN0_BLE_POS)
#define SYS_CTRL_CLK_EN0_BLE                        SYS_CTRL_CLK_EN0_BLE_MASK

#define SYS_CTRL_CLK_EN0_BLEMDM_BYPASSPOS           (31UL) 
#define SYS_CTRL_CLK_EN0_BLEMDM_BYPASSPOS_MASK      (1UL << SYS_CTRL_CLK_EN0_BLEMDM_BYPASSPOS)
#define SYS_CTRL_CLK_EN0_BLEMDM_BYPASS              SYS_CTRL_CLK_EN0_BLEMDM_BYPASSPOS_MASK
