 ...
 * @{
 */
#define AUDIO_ADC_INT_MASK_NONE         0x00000000UL
#define AUDIO_ADC_INT_MASK_FULL         0x00000001UL
#define AUDIO_ADC_INT_MASK_EMPTY        0x00000002UL
#define AUDIO_ADC_INT_MASK_WATER        0x00000004UL
#define AUDIO_ADC_INT_MASK_OVERFLOW     0x00000010UL
#define AUDIO_ADC_INT_MASK_UNDERFLOW    0x00000008UL
/**
 * @}
 */
...
{
    SET_BIT(SYS_CTRL->AUD_ADC_CFG2, AUDIO_ADC_CFG_DMA_EN);
}
...
{
    CLEAR_BIT(SYS_CTRL->AUD_ADC_CFG2, AUDIO_ADC_CFG_DMA_EN);
}
...
{
    SET_BIT(SYS_CTRL->AUD_ADC_CFG2, AUDIO_ADC_CFG_INT_EN);
}
...
{
    CLEAR_BIT(SYS_CTRL->AUD_ADC_CFG2, AUDIO_ADC_CFG_INT_EN);
}
...
{
    SET_BIT(SYS_CTRL->AUD_ADC_CFG2, AUDIO_ADC_CFG_FIFO_FLUSH);
}
...
{
    CLEAR_BIT(SYS_CTRL->AUD_ADC_CFG2, AUDIO_ADC_CFG_FIFO_FLUSH);
}
...
{
    SET_BIT(SYS_CTRL->AUD_ADC_CFG2, (mask << AUDIO_ADC_CFG_INT_MASK_POS));
}
...
{
    CLEAR_BIT(SYS_CTRL->AUD_ADC_CFG2, (unmask << AUDIO_ADC_CFG_INT_MASK_POS));
}
...
{
    return ((READ_REG(SYS_CTRL->AUD_ADC_CFG2) & (AUDIO_ADC_FIFO_STA_FULL << AUDIO_ADC_CFG_FIFO_STA_POS)) != 0);
}
...
{
    return ((READ_REG(SYS_CTRL->AUD_ADC_CFG2) & (AUDIO_ADC_FIFO_STA_EMPTY << AUDIO_ADC_CFG_FIFO_STA_POS)) != 0);
}
...
{
    return ((READ_REG(SYS_CTRL->AUD_ADC_CFG2) & (AUDIO_ADC_FIFO_STA_WATER << AUDIO_ADC_CFG_FIFO_STA_POS)) != 0);
}
...
{
    return ((READ_REG(SYS_CTRL->AUD_ADC_CFG2) & (AUDIO_ADC_FIFO_STA_OVERFLOW << AUDIO_ADC_CFG_FIFO_STA_POS)) != 0);
}
...
{
    return ((READ_REG(SYS_CTRL->AUD_ADC_CFG2) & (AUDIO_ADC_FIFO_STA_UNDERFLOW << AUDIO_ADC_CFG_FIFO_STA_POS)) != 0);
}
...
{
    return (uint16_t) (READ_REG(SYS_CTRL->AUD_ADC_RDATA) & AUDIO_ADC_FIFO_RDATA_DATA);
}
...
{
    MODIFY_REG(SYS_CTRL->AUD_ADC_CFG2, AUDIO_ADC_CFG_FIFO_WATER_LEVEL_MASK,
...
{
    return ((READ_REG(SYS_CTRL->AUD_ADC_CFG2) & AUDIO_ADC_CFG_FIFO_WATER_LEVEL_MASK) >> AUDIO_ADC_CFG_FIFO_WATER_LEVEL_POS);
}
