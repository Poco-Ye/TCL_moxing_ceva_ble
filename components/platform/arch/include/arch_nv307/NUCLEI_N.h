...
//modified by jiangde    Interrupt19_IRQn    = 19,                /*!< Device Interrupt*/
//modified by jiangde    Interrupt20_IRQn    = 20,                /*!< Device Interrupt*/
//modified by jiangde    Interrupt21_IRQn    = 21,                /*!< Device Interrupt*/
//modified by jiangde    Interrupt22_IRQn    = 22,                /*!< Device Interrupt*/
//modified by jiangde    Interrupt23_IRQn    = 23,                /*!< Device Interrupt*/
//modified by jiangde    Interrupt24_IRQn    = 24,                /*!< Device Interrupt*/
//modified by jiangde    Interrupt25_IRQn    = 25,                /*!< Device Interrupt*/
//modified by jiangde    Interrupt26_IRQn    = 26,                /*!< Device Interrupt*/
//modified by jiangde    Interrupt27_IRQn    = 27,                /*!< Device Interrupt*/
//modified by jiangde    Interrupt28_IRQn    = 28,                /*!< Device Interrupt*/
//modified by jiangde    Interrupt29_IRQn    = 29,                /*!< Device Interrupt*/
//modified by jiangde    Interrupt30_IRQn    = 30,                /*!< Device Interrupt*/
//modified by jiangde    Interrupt31_IRQn    = 31,                /*!< Device Interrupt*/
    BLE_IRQn              = 19,                /*!< Device Interrupt*/
    UART0_IRQn            = 20,                /*!< Device Interrupt*/
    UART1_IRQn            = 21,                /*!< Device Interrupt*/
    UART2_IRQn            = 22,                /*!< Device Interrupt*/
    IR_IRQn               = 23,                /*!< Device Interrupt*/
    GPIO_IRQn             = 24,                /*!< Device Interrupt*/
    I2C0_IRQn             = 25,                /*!< Device Interrupt*/
    I2C1_IRQn             = 26,                /*!< Device Interrupt*/
    SPI0_IRQn             = 27,                /*!< Device Interrupt*/
    SPI1_IRQn             = 28,                /*!< Device Interrupt*/
    QSPI_IRQn             = 29,                /*!< Device Interrupt*/
    WDG_IRQn              = 30,                /*!< Device Interrupt*/
    DMAC_IRQn             = 31,                /*!< Device Interrupt*/
    TIMER_IRQn            = 32,                /*!< Device Interrupt*/
    PWM_IRQn              = 33,                /*!< Device Interrupt*/
    KEYSCAN_IRQn_to1     = 34,                /*!< Device Interrupt*/
    KEYSCAN_IRQn         = 35,                /*!< Device Interrupt*/
    I2S0_IRQn             = 36,                /*!< Device Interrupt*/
    I2S1_IRQn             = 37,                /*!< Device Interrupt*/
    AUXADC_IRQn           = 38,                /*!< Device Interrupt*/
    AUDADC_IRQn           = 39,                /*!< Device Interrupt*/
    WAKEUP_IRQn           = 40,                /*!< Device Interrupt*/
    RTC_IRQn              = 41,                /*!< Device Interrupt*/
    TRNG_IRQn             = 42,                /*!< Device Interrupt*/
    IR1_IRQn                = 43,
    SOC_INT_MAX,
} IRQn_Type;
...
//modified by jiangde #define __ECLIC_BASEADDR          0x0C000000UL          /*!< Set to ECLIC baseaddr of your device */
#define __ECLIC_BASEADDR          0xE0010000UL          /*!< Set to ECLIC baseaddr of your device */
//modified by jiangde #define __ECLIC_INTCTLBITS        8                     /*!< Set to 1 - 8, the number of hardware bits are actually implemented in the clicintctl registers. */
...
//modified by jiangde #define __SYSTIMER_BASEADDR       0x02000000UL          /*!< Set to SysTimer baseaddr of your device */
#define __SYSTIMER_BASEADDR       0xE0020000UL          /*!< Set to SysTimer baseaddr of your device */
...
//modified by jiangde #define __PMP_ENTRY_NUM           16                    /*!< Set to 8 or 16, the number of PMP entries */
#define __PMP_ENTRY_NUM           8                    /*!< Set to 8 or 16, the number of PMP entries */
//modified by jiangde #define __ICACHE_PRESENT          0                     /*!< Set to 1 if I-Cache is present */
