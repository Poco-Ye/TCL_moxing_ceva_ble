...
#define BLE_SLEEP_NVDS_SUPPORT      1
...
// check if isochronous is enabled or not
    ...
    #define BLE_ISO_HW_PRESENT             (1)
#else // !(defined(CFG_ISO_CON) && (CFG_ISO_CON > 0))
    #define BLE_ISO_PRESENT                (0)
    #define BLE_ISO_HW_PRESENT             (BLE_EMB_PRESENT && !defined(CFG_BLE_ISO_HW_SUPPORT_NOT_PRESENT))
...
/// Bluebud TWS Data Path
#if defined(CFG_BLUEBUD_PRIMARY)
    #define BLE_BLUEBUD_TWS_TX           (BLE_ISO_PRESENT)
#else
    #define BLE_BLUEBUD_TWS_TX           (0)
#endif // defined(CFG_BLUEBUD_PRIMARY)

#if defined(CFG_BLUEBUD_SECONDARY)
    #define BLE_BLUEBUD_TWS_RX           (BLE_ISO_PRESENT)
#else
    #define BLE_BLUEBUD_TWS_RX           (0)
#endif // defined(CFG_BLUEBUD_SECONDARY)

#if (BLE_BLUEBUD_TWS_RX || BLE_BLUEBUD_TWS_TX)
    #define BLE_BLUEBUD_TWS              (BLE_ISO_PRESENT)
#else
    #define BLE_BLUEBUD_TWS              (0)
#endif // (BLE_BLUEBUD_TWS_RX || BLE_BLUEBUD_TWS_TX)
...
/// Time for TCL electric sleep time, 12.5ms*65 = 812.5ms(0.815s)
#define TCL_SLEEP_DURATION_TIME                 163840 //26080
...
#define SLEEP_ENTER_FUNC_MARGIN         480     // 15ms at 32kHz, 122 us at 32.768kHz
#define SLEEP_WAKEUP_FUNC_MARGIN        1440    // 45 ms at 32kHz, 91.5 us at 32.768kHz
#define SLEEP_WAKEUP_CLOCK_CORR_MARGIN  100     // 3.125ms at 32kHz, 305 us at 32.768kHz
...
#if defined(CFG_SYSTEM_MEM_PROVISION_SIZE)
    #define SYSTEM_MEM_PROVISION_SIZE               (CFG_SYSTEM_MEM_PROVISION_SIZE)
#else // CFG_SYSTEM_MEM_PROVISION_SIZE
    #define SYSTEM_MEM_PROVISION_SIZE               (0)
#endif // CFG_SYSTEM_MEM_PROVISION_SIZE
...
#if defined(CFG_RTOS)
#define RTOS_PRESENT (1)
#else
#define RTOS_PRESENT (0)
#endif
...
#if (HOST_PRESENT)
#define HOST_HEAP_MSG_SIZE_     (HOST_HEAP_MSG_SIZE)
#define HOST_HEAP_ENV_SIZE_     (HOST_HEAP_ENV_SIZE)
#define HOST_HEAP_PROFILE_SIZE_ (HOST_HEAP_PROFILE_SIZE)
#else
#define HOST_HEAP_MSG_SIZE_     (0)
#define HOST_HEAP_ENV_SIZE_     (0)
#define HOST_HEAP_PROFILE_SIZE_ (0)
#endif // (HOST_PRESENT)
...
#define RWIP_HEAP_PROFILE_SIZE     (  HOST_HEAP_PROFILE_SIZE_  )
...
enum rwip_prio_idx
{
    ...
    #endif // (BLE_BIS)
    /// Priority for Channel Scanning activity
...
enum rwip_prio_dft
{
    ...
    #endif // (BLE_BIS)
    /// Default priority for Channel Scanning activity
