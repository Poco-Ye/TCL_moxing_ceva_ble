...
/// Selection type for a display screen
enum display_select_type
{
    DISPLAY_SELECT_TYPE_NORMAL = 0,
    DISPLAY_SELECT_TYPE_PUSH,
};
...
/**
 ****************************************************************************************
 * @brief   Set behaviour when display screen is selected
 ****************************************************************************************
 */
