 ...
 */
/// Key identifier "btle"
__STATIC const uint8_t aes_f5_key_id[4]    = {0x65,0x6c,0x74,0x62};
/// Salted key
__STATIC const uint8_t aes_f5_key_salt[16] = {0xBE,0x83,0x60,0x5A,0xDB,0x0B,0x37,0x60,0x38,0xA5,0xF5,0xAA,0x91,0x83,0x88,0x6C};
