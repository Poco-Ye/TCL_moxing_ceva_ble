...
/// Alert category bit field (see #anp_cat_id_bit_mask_t)
...
typedef struct anp_unread_alert
{
    /// Category ID
    uint8_t cat_id;
    /// Number of alert
