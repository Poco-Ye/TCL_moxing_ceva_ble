...
#define LANP_LAN_NAVIGATION_MAX_LEN             (19)
...
/// LAN CT Point timeout (in milliseconds)
#define LANP_CP_TIMEOUT                         (30000)
...
/// LAN Navigation
typedef struct lanp_navigation
{
    /// Flags
    uint16_t        flags;
    /// Bearing
    ...
    prf_date_time_t estimated_arrival_time;
} lanp_navigation_t;

/// LAN Position quality
typedef struct lanp_posq
{
    /// Flags
    uint16_t flags;
    /// Time to First Fix
...
typedef struct lanp_ln_ctnl_pt_rsp
{
