...
typedef struct hogprh_cb
{
     ...
     ****************************************************************************************
     */
    void (*cb_read_report_map_cmp)(uint8_t conidx, uint16_t status, uint8_t hid_idx, co_buf_t* p_report_map);
     ...
     ****************************************************************************************
     */
    void (*cb_read_report_cmp)(uint8_t conidx, uint16_t status, uint8_t hid_idx, uint8_t report_idx, co_buf_t* p_report);
     ...
     ****************************************************************************************
     */
    void (*cb_report)(uint8_t conidx, uint8_t hid_idx, uint8_t report_idx, co_buf_t* p_report);
} hogprh_cb_t;
 ...
 *
 * Wait for #cb_read_proto_mode_cmp execution before starting a new procedure
 *
 * @param[in] conidx        Connection index
 * @param[in] hid_idx       HID Service Instance - From 0 to HOGPRH_NB_HIDS_INST_MAX-1
 *
 ...
 *
 * Wait for #cb_read_hid_info_cmp execution before starting a new procedure
 *
 * @param[in] conidx        Connection index
 * @param[in] hid_idx       HID Service Instance - From 0 to HOGPRH_NB_HIDS_INST_MAX-1
 *
 ...
 *
 * Wait for #cb_read_report_map_cmp execution before starting a new procedure
 *
 * @param[in] conidx        Connection index
 * @param[in] hid_idx       HID Service Instance - From 0 to HOGPRH_NB_HIDS_INST_MAX-1
 *
 ...
 *
 * Wait for #cb_read_report_map_ref_cmp execution before starting a new procedure
 *
 * @param[in] conidx        Connection index
 * @param[in] hid_idx       HID Service Instance - From 0 to HOGPRH_NB_HIDS_INST_MAX-1
 *
 ...
 *
 * Wait for #cb_read_report_cfg_cmp execution before starting a new procedure
 *
 * @param[in] conidx        Connection index
 * @param[in] hid_idx       HID Service Instance - From 0 to HOGPRH_NB_HIDS_INST_MAX-1
 * @param[in] report_idx    Index of the report in the service
 ...
 *
 * Wait for #cb_read_report_cmp execution before starting a new procedure
 *
 * @param[in] conidx        Connection index
 * @param[in] hid_idx       HID Service Instance - From 0 to HOGPRH_NB_HIDS_INST_MAX-1
 * @param[in] report_idx    Index of the report in the service
 ...
 *
 * Wait for #cb_read_report_ref_cmp execution before starting a new procedure
 *
 * @param[in] conidx        Connection index
 * @param[in] hid_idx       HID Service Instance - From 0 to HOGPRH_NB_HIDS_INST_MAX-1
 * @param[in] report_idx    Index of the report in the service
 ...
 *
 * Wait for #cb_write_proto_mode_cmp execution before starting a new procedure
 *
 * @param[in] conidx        Connection index
 * @param[in] hid_idx       HID Service Instance - From 0 to HOGPRH_NB_HIDS_INST_MAX-1
 * @param[in] proto_mode    Protocol mode
 ...
 *
 * Wait for #cb_write_report_cfg_cmp execution before starting a new procedure
 *
 * @param[in] conidx        Connection index
 * @param[in] hid_idx       HID Service Instance - From 0 to HOGPRH_NB_HIDS_INST_MAX-1
 * @param[in] report_idx    Index of the report in the service
 ...
 *
 * Wait for #cb_write_report_cmp execution before starting a new procedure
 *
 * @param[in] conidx        Connection index
 * @param[in] hid_idx       HID Service Instance - From 0 to HOGPRH_NB_HIDS_INST_MAX-1
 * @param[in] report_idx    Index of the report in the service
