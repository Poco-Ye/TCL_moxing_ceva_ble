...
typedef struct hogpbh_cb
{
     ...
     ****************************************************************************************
     */
    void (*cb_read_report_cmp)(uint8_t conidx, uint16_t status, uint8_t hid_idx, uint8_t val_id, co_buf_t* p_report);
     ...
     ****************************************************************************************
     */
    void (*cb_report)(uint8_t conidx, uint8_t hid_idx, uint8_t val_id, co_buf_t* p_report);
} hogpbh_cb_t;
