...
/// Google Fast Pair
#if defined(CFG_PRF_GFP_PROVIDER)
#define GFP_PROVIDER         1
#else
#define GFP_PROVIDER         0
#endif // defined(CFG_PRF_GFP_PROVIDER)
...
#if defined(CFG_PRF_GATVS)
#define BLE_GATV_SERVER          1
#else
#define BLE_GATV_SERVER          0
#endif 
...
/// PBAP Client profile
#if defined (CFG_PRF_PBAP_CLIENT)
#define BT_PBAP_CLIENT        1
#else
#define BT_PBAP_CLIENT        0
#endif // defined (CFG_PRF_HFP_AG)

/// Apple iPod Accessory Profile
#if defined (CFG_PRF_APPLE_IAP)
#define APPLE_IAP             1
#else
#define APPLE_IAP             0
#endif // defined (CFG_PRF_APPLE_IAP)
