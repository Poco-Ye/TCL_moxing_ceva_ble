...
enum gatt_char
{
    ...
    GATT_SVC_COMMON_AUDIO                        = GATT_UUID_16_LSB(0x8FDD), //!< Value: 0x8FDD
    /// Telephony and Media Audio Service
    GATT_SVC_TELEPHONY_MEDIA_AUDIO               = GATT_UUID_16_LSB(0x8FE0), //!< Value: 0x8FE0
    /// Hearing Access Service
    GATT_SVC_HEARING_ACCESS                      = GATT_UUID_16_LSB(0x8FE1), //!< Value: 0x8FE1
    ...
    GATT_CHAR_HAS_FEATURES                       = GATT_UUID_16_LSB(0x8FCA), //!< Value: 0x8FCA
    /// Hearing Access Service - Hearing Aid Preset Control Point characteristic
    GATT_CHAR_HAS_CP                             = GATT_UUID_16_LSB(0x8FCB), //!< Value: 0x8FCB
    /// Hearing Access Service - Active Preset Index characteristic
    GATT_CHAR_HAS_ACTIVE_PRESET_INDEX            = GATT_UUID_16_LSB(0x8FCC), //!< Value: 0x8FCC
