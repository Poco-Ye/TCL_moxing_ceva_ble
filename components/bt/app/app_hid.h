...
//#include "../../../plf/bluegrip/src/driver/ps2/ps2.h"             // PS2 Mouse Driver
...
#define APP_HID_REPORT_ID_KEYBOARD        (1)
#define APP_HID_REPORT_ID_MOUSE           (2)
#define APP_HID_REPORT_ID_VENDOR1         (0xFC)
#define APP_HID_REPORT_ID_VENDOR2		  (0xFB)
#define APP_HID_REPORT_ID_MMKB			  (3)
#define APP_HID_REPORT_ID_KUKONG1		  (4)
#define APP_HID_REPORT_ID_KUKONG2		  (5)
#define APP_HID_REPORT_ID_KUKONG3		  (6)


#define APP_HID_REPORT_ID_KEYBOARD_INDEX  (0)
#define APP_HID_REPORT_ID_KEYBOARD_OUT_INDEX (1)
//#define APP_HID_REPORT_ID_MOUSE_INDEX     (2)
#define APP_HID_REPORT_ID_MMKB_INDEX		(2)
#define APP_HID_REPORT_ID_VENDOR1_INDEX     (3)
#define APP_HID_REPORT_ID_VENDOR1_OUT_INDEX     (4)
#define APP_HID_REPORT_ID_VENDOR2_INDEX     (5)
#define APP_HID_REPORT_ID_VENDOR2_OUT_INDEX     (6)
