...
/* pyxue#define UNITY_TEST_REG_HELPER reg_helper ## UNITY_TEST_UID
...
{
    const char* name;
    struct test_menu_t* next;
    //struct test_menu_t* submenu;
    struct test_desc_t* item;
}test_menu_t;
...
#define TEST_CASE(menuname_, name_, desc_) \
