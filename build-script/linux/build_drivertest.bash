...
cmake ../tools/test_drivers -G"Unix Makefiles"  -DBOARD=$board_name -DSOC=$soc_name
echo "start make"
make
riscv-nuclei-elf-objdump  -S -d   test_driver_sdk > test_driver_sdk.asm
riscv-nuclei-elf-objcopy -O binary "test_driver_sdk"  "test_driver_sdk.bin"
riscv-nuclei-elf-size --format=berkeley "test_driver_sdk"
